...
> If using VS Code install the Flutter Package from the extension and select the
> emulator or device in the VS Code and the run without debugging

![first app](../Images/first-app.png){ width="250" }
/// caption
Build of the boiler plate app may look different in future
///
